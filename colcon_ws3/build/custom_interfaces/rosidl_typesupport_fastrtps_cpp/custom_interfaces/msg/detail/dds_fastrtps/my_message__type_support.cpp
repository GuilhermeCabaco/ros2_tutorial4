...
#include "custom_interfaces/msg/detail/my_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::MyMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::MyMessage & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::MyMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::MyMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::MyMessage *>(
    untyped_ros_message);
...
get_message_type_support_handle<custom_interfaces::msg::MyMessage>()
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_MyMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, MyMessage)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_MyMessage__handle;
}
